...
namespace WebApi.Commands.EditDCandiate
{
    public class EditDCandiateCommandValidator : AbstractValidator<EditDCandiateCommand>
    {
        public EditDCandiateCommandValidator()
        {
